/**
 * BLOCK: blkcanvas-woocommerce-registration-form
 *
 ...
 */
registerBlockType( 'blkcanvas/woocommerce-registration-form', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'Registration Form - Blkcanvas' ), // Block title.
